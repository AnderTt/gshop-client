<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      <img :src="info.avatar" class="content-image" @click="isShowShopBriefModal=true">
    ...
    <div class="shop-header-discounts" v-if="info.supports"  @click="isShowActivitySheet=true" >
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="isShowShopBriefModal">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="isShowShopBriefModal=false">
    ...
    <transition name="move">
      <div class="activity-sheet" v-show="isShowActivitySheet">
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">优惠活动</h2>
          <ul class="list">
            <li class="activity-item" v-for="(support,index) in info.supports" :key="index"
                :class="supportsClasses[support.type]">
              <span class="content-tag">
          ...
          <div class="activity-sheet-close" @click="isShowActivitySheet=false">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
...
<script>
  ...
  export default {
    data(){
      return {
        isShowShopBriefModal : false,
        isShowActivitySheet : false,
        //supports数字中type: 0-->activity-green
        //supports数字中type: 1-->activity-red
        //supports数字中type: 2-->activity-orange

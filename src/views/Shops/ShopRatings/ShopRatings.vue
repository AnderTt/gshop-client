      ...
      <div class="overview">
        ...
        <div class="overview-right">
          ...
          <div class="score-wrapper">
            ...
            <span class="score">{{info.score}}</span></div>
 ...
 export default {
  data (){
    return {
      ...
      onlyContent : false //是否只看有评论内容的评论
    }
  },
  computed : {
    ...
    ratingsFilter() {
       ...
       */
      /*条件2 ：
      onlyContent = false //所有的都看
      onlyContent = true //只看有评论内容的评论
      rating.text.length > 0
      onlyContent === false || rating.text.length>0
       */
      const {selectType, onlyContent, ratings} = this

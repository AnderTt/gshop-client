  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item" v-for="(support,index) in info.supports" :key="index" :class="supportsClasses[support.type]"  >
  ...
  export default {
    ...
    methods : {
     _initBScroll(){
       ...
       const liWidth = 120
       const space = 6
       const {pics} = this.info
       this.$refs.picUl.style.width = (liWidth + space) * pics.length  - space + 'px'
